...
// // MARK: 添加了width和height参数
// export function createHeroView(container: HTMLElement) {
...
//   const [planePoints, pointMaterial] = createPlaneParticle({ xCount: 65, yCount: 50 });
