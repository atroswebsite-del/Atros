...
export default function BlogCard({
  ...
  useGSAP(
    (_context, contextSafe) => {
      ...
      if (!root || !coverImage || !contextSafe) return;
      ...
      mm.add(
        ...
        () => {
          const covers = gsap.utils.toArray<HTMLElement>(
            root.querySelectorAll('[data-blog-cover] img'),
          );
    ...
    { scope: cardRef, dependencies: [coverImage, slug] },
  );
    ...
    <div ref={cardRef}>
      ...
      <div className="lg:hidden">
        {isLarge ? (
          ...
          >
            <div className="flex flex-row">
              {coverImage ? (
                <div
                  data-blog-cover
                  className="relative aspect-[345/496] xl:aspect-[345/496] overflow-hidden 
              ...
              <div
                className={`flex-1 flex flex-col justify-start ${coverImage ? 'ml-[30px] xl:ml-[25px]' : ''}`}
              >
                <span className="text-[32px] xl:text-[28px] font-xbold text-gray-1">
                  {title}
                </span>
                <p
                  className="text-[26px] xl:text-[24px] font-normal text-left text-gray-1 
                              mt-[40px] xl:mt-[32px]
                ...
                <span
                  className="text-[18px] xl:text-[20px] font-xbold text-gray-1 
                               mt-[40px] xl:mt-[32px]"
                >
                  {t('read_more')}
                </span>
            ...
            <div className="w-full mx-auto flex flex-row justify-end items-center pt-[18px] xl:pt-[15px]">
              <span
                lang="en"
                className="text-[18px] xl:text-[16px] font-bold text-gray-1 whitespace-nowrap"
              >
                {date}
              </span>
            </div>
          ...
          <div
            className="max-w-[1440px] mx-auto flex-col
                        bg-white-0 rounded-30 overflow-hidden border-gray-0 border-[1px]
                          px-[75px] pt-[75px] pb-[45px] pr-[75px]
                          xl:px-[30px] xl:pt-[30px] xl:pb-[30px]
                          "
          >
            <h2 className="text-[36px] xl:text-[28px] font-xbold text-gray-1">{title}</h2>
            <p
              className="text-[30px] xl:text-[24px] font-normal text-left text-gray-1 
                          mt-[40px] xl:mt-[32px]
      ...
      <div className="hidden lg:flex">
        {isLarge ? (
          <div
            className="w-full mx-auto flex-col justify-start overflow-hidden
          ...
          >
            {coverImage ? (
              <div
                data-blog-cover
                className="relative overflow-hidden border-gray-0 border-b-[1px]
            ...
            >
              ...
              <p
                className="lg:text-[24px] md:text-md-16 font-normal text-left text-gray-1 
            ...
            <div
              className="w-full mx-auto flex flex-row justify-end
          ...
          >
            ...
            <p
              className="lg:text-[28px] md:text-md-16 font-normal text-left text-gray-1 
