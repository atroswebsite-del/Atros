...
export default function HomeFoundersSection() {
  ...
  return (
    <section className="mt-[40px] w-full max-w-full border-gray-0 border-b-[1px] pb-[50px] text-left xl:mt-[40px] xl:pb-[40px] lg:mt-[90px] md:mt-md-48 md:pb-md-48">
      <span className="block px-[16px] text-center font-xbold-tight text-gray-1 text-120 xl:text-[min(12vw,120px)] lg:text-lg-36 md:text-md-25">
        {t('text_founders.title')}
      </span>
      <div className="mt-[40px] flex w-full flex-row gap-[80px] px-[16px] lg:gap-[48px] md:mt-md-16 md:flex-col md:gap-md-32">
